    ...
    >
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600'>Simply type a text-prompt, and our cutting-edge AI will generate high-quality images in seconds. From product visuals to character designs and potraits, even concepts that don't yet exist can be visualized effortlessly. Powered by andvanced AI technology, the creative possibilitis are limitless!</p>
        </div>
      </div>
    </motion.div>
  )
